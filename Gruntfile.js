module.exports = function(grunt) {
	...
	grunt.initConfig({
		dir: {
			...
			css_base: 'it/designfuture/lightbox/themes/base/library.source.less',
			css_belize: 'it/designfuture/lightbox/themes/sap_belize/library.source.less',
			sap_bluecrystal: 'it/designfuture/lightbox/themes/sap_bluecrystal/library.source.less'
		},
		...
		openui5_preload: {
		    library: {
		        options: {
		            resources: [
		                { cwd: '<%= dir.src %>' },
		                { cwd: '<%= dir.src_lib %>', src: 'lightbox.min.js', prefix: 'it/designfuture/lightbox/3rdparty' }
		            ],
		            dest: '<%= dir.dest %>',
		            compatVersion: '1.44',
		            compress: false
		        },
		        libraries: 'it/designfuture/lightbox'
		    }
		},
